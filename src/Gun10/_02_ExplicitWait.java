...
public class _02_ExplicitWait extends BasicStaticDriver {
    public static void main(String[] args) {
        ...
        // Bu locater daki eleman , görünene kadar bekle

        //WebElement webDriverText = driver.findElement(By.xpath("//p[text()='WebDriver']"));
        System.out.println("webDriver.getText() = " + webDriverText.getText());
